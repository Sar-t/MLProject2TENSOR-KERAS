...
## Load model and scaler and ohe pickel file
...
geo_encoded_df = pd.DataFrame(geo_encoded.toarray(),columns=ohe_encoder_geo.get_feature_names_out(['Geography']))
...
st.write(f'Churn Prob:',prediction_prob)
